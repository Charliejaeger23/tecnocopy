...
def normalize(raw: dict) -> dict:
    ...
    return {
        ...
        "created_at": _s(raw.get("creation-date") or raw.get("created_at") or raw.get("utc-creation-date") or "1970-01-01T00:00:00Z"),
        "updated_at": _s(raw.get("utc-last-modification-date") or raw.get("updated_at") or raw.get("modifiedAt") or raw.get("creation-date") or "1970-01-01T00:00:00Z"),
    }
